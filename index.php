<?php
	...
	$themes = [
		["name" => "snow", "title" => "Seasons Greetings for a White Christmas, " . $name . "!", "prompt" => "Generate a short paragraph, of less than 100 words, as a greeting on a Christmas Card, involving snow and winter"],
		...
		["name" => "nativity", "title" => "Have a blessed Christmas, " . $name . "!", "prompt" => "Generate a short paragraph, of less than 50 words, as a greeting on a Christmas Card, involving Jesus and the Nativity"]
	];
